...
const product = {
  ...
  name: "useknockout",
  description:
    "Open-source image API for developers. Background removal, super-resolution, face restore, sticker outlines, studio composites, batch processing, and 23 endpoints. ~200ms per call. MIT licensed, self-hostable, 40x cheaper than remove.bg.",
